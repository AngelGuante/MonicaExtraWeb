var app = new Vue({
    ...
    watch: {
        ...
        'Reportes.VentasYDevolucionesCategoriaYVendedorFILTROS.hasta'() {
            this.Reportes.VentasYDevolucionesCategoriaYVendedorFILTROS.hasta = this.Reportes.VentasYDevolucionesCategoriaYVendedorFILTROS.desde.replace(/^0/g, '');
        }
    },
    methods: {
        //  DIV PARA LOGEARSE
    ...
    filters: {
        ...
        FilterDateFormat: value => {
            ...
            const fecha = `${(date.getDate()).padStart(2, '0')}/${(date.getMonth() + 1).padStart(2, '0')}/${date.getFullYear()}`;
