const manejoDeData_cotizaciones = new Vue({
    el: '#manejoDeData_Cotizaciones',
    ...
    methods: {
        async Cerrar() {
            if (!this.valorValidoSePuedeCerrar)
            ...
            else if (this.tipoCierre === 'Genero_Ventas' && !this.FormularioValidoSePuedeCerrar)
                await MostrarMensage({
                    title: 'Falta Información',
                ...
                await monicaManejoDeData.BuscarData('actualizarEstimado', filtro);
        ...
        async BuscarDatosParaCerrarCotizacion() {
            ...
            this.datosParaCierreBuscados = await monicaManejoDeData.BuscarData('obtenerCotizacion', filtro);
        ...
        async BuscarExistenciaFacturaEnOtroCierre() {
            ...
            this.ValidarDatosNroFactura((await monicaManejoDeData.BuscarData('obtenerEstimado', filtro))[0].count);
        },
